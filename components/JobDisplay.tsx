      ...
      <div className="w-1/3 overflow-y-auto border-r border-gray-200 dark:border-gray-700">
        {jobs.map((job) => (
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Requirements:</strong> {job.requirements}</p>
            <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Qualifications:</strong> {job.qualifications}</p>
            <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Salary:</strong> {job.salary}</p>
          </div>
        ))}
      </div>
            ...
            <div className="text-gray-800 dark:text-white">
              <div className="flex">
                ...
                <div className="grow-0">
                  <Button className="bg-gray-800 hover:bg-gray-700 cursor-pointer">Apply for this</Button>
                </div>
              </div>
